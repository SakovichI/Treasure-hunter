...
const startGame = (time, countTreasure) => {
	...
	const createScene = async function () {
		...
		const creatGround = (x, y, z) => {
			...
			const groundTexture = new BABYLON.Texture('https://playground.babylonjs.com/textures/floor.png')
			groundTexture.uScale = groundTexture.vScale = 15
			material.diffuseTexture = groundTexture

			const groundBumpTexture = new BABYLON.Texture('https://playground.babylonjs.com/textures/floor_bump.png')
		...
		//Текстуры мира
		const wall = new BABYLON.SceneLoader.ImportMeshAsync(null, './public/', 'WonderWalls_SecondAge.gltf', scene).then(
			result => {
				...
				wallLeftBox.physicsImpostor = new BABYLON.PhysicsImpostor(
					wallLeftBox,
					BABYLON.PhysicsImpostor.BoxImpostor,
					{
						mass: 0,
				...
				wallRightBox.physicsImpostor = new BABYLON.PhysicsImpostor(
					wallRightBox,
					BABYLON.PhysicsImpostor.BoxImpostor,
					{
						mass: 0,
				...
				wallFrontBox.physicsImpostor = new BABYLON.PhysicsImpostor(
					wallFrontBox,
					BABYLON.PhysicsImpostor.BoxImpostor,
					{
						mass: 0,
				...
				wallBack1Box.physicsImpostor = new BABYLON.PhysicsImpostor(
					wallBack1Box,
					BABYLON.PhysicsImpostor.BoxImpostor,
					{
						mass: 0,
				...
				wallBack2Box.physicsImpostor = new BABYLON.PhysicsImpostor(
					wallBack2Box,
					BABYLON.PhysicsImpostor.BoxImpostor,
					{
						mass: 0,
		...
		const port = new BABYLON.SceneLoader.ImportMeshAsync(null, './public/', 'Port.gltf', scene).then(result => {
			...
			boxPort1.physicsImpostor = new BABYLON.PhysicsImpostor(
				boxPort1,
				BABYLON.PhysicsImpostor.BoxImpostor,
				{
					mass: 0,
			...
			const wallLeftPort1 = new BABYLON.MeshBuilder.CreateBox(
				'wallLeftPort',
				{ width: 20, height: 20, depth: 1 },
				scene
			)
			wallLeftPort1.position = new BABYLON.Vector3(-60.0, 3.0, 6)
			wallLeftPort1.physicsImpostor = new BABYLON.PhysicsImpostor(
				wallLeftPort1,
				BABYLON.PhysicsImpostor.BoxImpostor,
				{
					mass: 0,
			...
			const wallRightPort1 = new BABYLON.MeshBuilder.CreateBox(
				'wallRightPort',
				{
					width: 20,
					height: 20,
			...
			wallRightPort1.physicsImpostor = new BABYLON.PhysicsImpostor(
				wallRightPort1,
				BABYLON.PhysicsImpostor.BoxImpostor,
				{
					mass: 0,
			...
			const wallBackPort1 = new BABYLON.MeshBuilder.CreateBox(
				'wallBackPort',
				{ width: 1, height: 20, depth: 12 },
				scene
			)
			wallBackPort1.position = new BABYLON.Vector3(-70.0, 3.0, 0)
			wallBackPort1.physicsImpostor = new BABYLON.PhysicsImpostor(
				wallBackPort1,
				BABYLON.PhysicsImpostor.BoxImpostor,
				{
					mass: 0,
			...
			port.physicsImpostor = new BABYLON.PhysicsImpostor(
				port,
				BABYLON.PhysicsImpostor.NoImpostor,
				{
					mass: 0,
		...
		const createBarrel = (x, z) => {
			new BABYLON.SceneLoader.ImportMeshAsync(null, './public/', 'Barrel.gltf', scene).then(result => {
				...
				barrelBox.physicsImpostor = new BABYLON.PhysicsImpostor(
					barrelBox,
		...
		const creatHouse = (x, z) => {
			new BABYLON.SceneLoader.ImportMeshAsync(null, './public/', 'Houses.gltf', scene).then(result => {
				...
				house1Box.physicsImpostor = new BABYLON.PhysicsImpostor(
					house1Box,
					BABYLON.PhysicsImpostor.BoxImpostor,
					{
						mass: 0,
				...
				house2Box.physicsImpostor = new BABYLON.PhysicsImpostor(
					house2Box,
					BABYLON.PhysicsImpostor.BoxImpostor,
					{
						mass: 0,
		...
		//Create Farm
		const creatFarm = (x, z) => {
			new BABYLON.SceneLoader.ImportMeshAsync(null, './public/', 'Farm.gltf', scene).then(result => {
				...
				farmBox.physicsImpostor = new BABYLON.PhysicsImpostor(
					farmBox,
					BABYLON.PhysicsImpostor.BoxImpostor,
					{
						mass: 0,
				...
				farm.physicsImpostor = new BABYLON.PhysicsImpostor(
					farm,
					BABYLON.PhysicsImpostor.NoImpostor,
					{
						mass: 0,
		...
		//create center
		new BABYLON.SceneLoader.ImportMeshAsync(null, './public/', 'Center.gltf', scene).then(result => {
			...
			centerBox.physicsImpostor = new BABYLON.PhysicsImpostor(
				centerBox,
				BABYLON.PhysicsImpostor.BoxImpostor,
				{
					mass: 0,
			...
			center.physicsImpostor = new BABYLON.PhysicsImpostor(
				center,
				BABYLON.PhysicsImpostor.NoImpostor,
				{
					mass: 0,
		...
		const creatMarket = (x, z, rotate) => {
			new BABYLON.SceneLoader.ImportMeshAsync(null, './public/', 'Market.gltf', scene).then(result => {
				...
				market1Box.physicsImpostor = new BABYLON.PhysicsImpostor(
					market1Box,
					BABYLON.PhysicsImpostor.BoxImpostor,
					{
						mass: 0,
				...
				market2Box.physicsImpostor = new BABYLON.PhysicsImpostor(
					market2Box,
					BABYLON.PhysicsImpostor.BoxImpostor,
					{
						mass: 0,
				...
				market.physicsImpostor = new BABYLON.PhysicsImpostor(
					market,
					BABYLON.PhysicsImpostor.NoImpostor,
					{
						mass: 0,
		...
		//Create Temple
		new BABYLON.SceneLoader.ImportMeshAsync(null, './public/', 'Temple.gltf', scene).then(result => {
			...
			templeBox.physicsImpostor = new BABYLON.PhysicsImpostor(
				templeBox,
				BABYLON.PhysicsImpostor.BoxImpostor,
				{
					mass: 0,
			...
			temple.physicsImpostor = new BABYLON.PhysicsImpostor(
				temple,
				BABYLON.PhysicsImpostor.NoImpostor,
				{
					mass: 0,
		...
		//Create Archery
		new BABYLON.SceneLoader.ImportMeshAsync(null, './public/', 'Archery.gltf', scene).then(result => {
			...
			archeryBox.physicsImpostor = new BABYLON.PhysicsImpostor(
				archeryBox,
				BABYLON.PhysicsImpostor.BoxImpostor,
				{
					mass: 0,
			...
			archery1Box.physicsImpostor = new BABYLON.PhysicsImpostor(
				archery1Box,
				BABYLON.PhysicsImpostor.BoxImpostor,
				{
					mass: 0,
			...
			archery.physicsImpostor = new BABYLON.PhysicsImpostor(
				archery,
				BABYLON.PhysicsImpostor.NoImpostor,
				{
					mass: 0,
			...
			fenceBox.physicsImpostor = new BABYLON.PhysicsImpostor(
				fenceBox,
				BABYLON.PhysicsImpostor.BoxImpostor,
				{
					mass: 0,
		...
		//Create Barracks
		new BABYLON.SceneLoader.ImportMeshAsync(null, './public/', 'Barracks.gltf', scene).then(result => {
			...
			barrackBox.physicsImpostor = new BABYLON.PhysicsImpostor(
				barrackBox,
				BABYLON.PhysicsImpostor.BoxImpostor,
				{
					mass: 0,
			...
			barrack1Box.physicsImpostor = new BABYLON.PhysicsImpostor(
				barrack1Box,
				BABYLON.PhysicsImpostor.BoxImpostor,
				{
					mass: 0,
			...
			barrack.physicsImpostor = new BABYLON.PhysicsImpostor(
				barrack,
				BABYLON.PhysicsImpostor.NoImpostor,
				{
					mass: 0,
		...
		const createTowerHouse = (x, z) => {
			new BABYLON.SceneLoader.ImportMeshAsync(null, './public/', 'TowerHouse.gltf', scene).then(result => {
				...
				const towerHouseBox = new BABYLON.MeshBuilder.CreateBox(
					'towerHouseBox',
					{
						width: 20,
						height: 10,
				...
				towerHouseBox.physicsImpostor = new BABYLON.PhysicsImpostor(
					towerHouseBox,
					BABYLON.PhysicsImpostor.BoxImpostor,
					{
						mass: 0,
				...
				towerHouse.physicsImpostor = new BABYLON.PhysicsImpostor(
					towerHouse,
					BABYLON.PhysicsImpostor.NoImpostor,
					{
						mass: 0,
		...
		const createTreasure = (x, z) => {
			new BABYLON.SceneLoader.ImportMeshAsync(null, './public/', 'Chest.gltf', scene).then(result => {
		...
		const guardArray = []
		const createGuard = () => {
			const guard = new BABYLON.SceneLoader.ImportMeshAsync(null, './public/', 'guard.gltf', scene).then(result => {
		...
		createGuard()
		//Персонаж
		const person = new BABYLON.SceneLoader.ImportMeshAsync(null, './public/', 'Pirate_Male.gltf', scene).then(
			result => {
				...
				scene.onBeforeRenderObservable.add(() => {
					...
					if (Math.abs(axis.r) > 0.001) {
						targetRotation.multiplyInPlace(
							BABYLON.Quaternion.RotationAxis(BABYLON.Vector3.UpReadOnly, axis.r * rotAmount * deltaTime)
						)
					}
